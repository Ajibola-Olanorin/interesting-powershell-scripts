...
.LINK
	https://github.com/ajibola-olanorin/interesting-powershell-scripts

.NOTES
	Author: Ajibola Olanorin
#>


param([string]$DirTree = "C:\Users\ComputerName\Downloads", [int]$Days = 100)
